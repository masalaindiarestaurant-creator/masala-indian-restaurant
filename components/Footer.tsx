...
export default function Footer({ locale, copy, nav, brand }: Props) {
  const navLinks = [
    { href: "/", label: nav.home },
    { href: "/menu", label: copy.links.fullMenu },
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="mb-4">
              <p className="font-heading text-3xl font-normal tracking-[0.08em] text-cream">{brand.name}</p>
              <p className="section-label text-saffron mt-1">{brand.descriptor}</p>
            </div>
          ...
          {/* Navigation */}
          <div>
            <h4 className="section-label text-cream/60 mb-5">{copy.navigation}</h4>
          ...
          {/* Menu */}
          <div>
            <h4 className="section-label text-cream/60 mb-5">{copy.menu}</h4>
            <ul className="space-y-3">
              {menuLinks.map((l) => (
                <li key={l.href}>
                  <Link
          ...
          {/* Contact */}
          <div>
            <h4 className="section-label text-cream/60 mb-5">{copy.visit}</h4>
