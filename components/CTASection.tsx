        ...
        <RevealOnScroll>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <a
              ...
              className="group flex items-center gap-3 rounded-full bg-saffron text-cream px-8 py-4 text-sm font-semibold font-body hover:bg-saffron-dark transition-colors duration-300"
            >
